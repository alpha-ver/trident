...
class CommandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create command" do
    assert_difference('Command.count') do
      post commands_url, params: { command: { api_xbet: @command.api_xbet, created: @command.created, find_names: @command.find_names, name: @command.name, sport_id: @command.sport_id } }
    end
  ...
  test "should update command" do
    patch command_url(@command), params: { command: { api_xbet: @command.api_xbet, created: @command.created, find_names: @command.find_names, name: @command.name, sport_id: @command.sport_id } }
